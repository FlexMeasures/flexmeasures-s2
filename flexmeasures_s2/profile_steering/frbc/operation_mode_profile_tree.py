...
class OperationModeProfileTree:
    ...
    def convert_to_plan(self, first_timestep_index_with_state: int, end_state: FrbcState) -> S2FrbcPlan:
        ...
        return S2FrbcPlan(
            ...
            SoCProfile(self.profile_metadata, fill_level),
            actuators,
        )
