...
class S2FrbcDeviceStateWrapper:
    ...
    def operation_mode_uses_factor(self, target_timestep: FrbcTimestep, actuator_id: str, operation_mode_id: str) -> bool:
    ...
    def get_all_possible_actuator_configurations(self, target_timestep: FrbcTimestep) -> List[Dict[str, S2ActuatorConfiguration]]:
    ...
    def combination_to_map(self, cur: List[int], keys: List[str], possible_actuator_configs: Dict[str, List[S2ActuatorConfiguration]]) -> Dict[str, S2ActuatorConfiguration]:
        combination = {}
        for i, key in enumerate(keys):
            combination[key] = possible_actuator_configs[key][cur[i]]
        return combination

    def increase(self, cur: List[int], keys: List[str], possible_actuator_configs: Dict[str, List[S2ActuatorConfiguration]]) -> bool:
        cur[0] += 1
        for i, key in enumerate(keys):
